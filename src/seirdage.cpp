...
[[cpp11::register]]
SEXP dust_cpu_seirdage_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
...
[[cpp11::register]]
SEXP dust_cpu_seirdage_filter(SEXP ptr, SEXP step_end,
...
dust::pars_type<seirdage> dust_pars<seirdage>(cpp11::list user) {
  ...
  shared->dt = NA_REAL;
  shared->beta = 0.016500000000000001;
  ...
  shared->p_Ix = 1 - std::exp(- shared->gamma * shared->dt);
...
cpp11::sexp dust_info<seirdage>(const dust::pars_type<seirdage>& pars) {
  const seirdage::internal_type internal = pars.internal;
...
cpp11::sexp dust_seirdage_capabilities() {
  return dust::r::dust_capabilities<seirdage>();
}
...
SEXP dust_cpu_seirdage_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config) {
  return dust::r::dust_cpu_alloc<seirdage>(r_pars, pars_multi, step, r_n_particles,
