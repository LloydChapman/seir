...
[[cpp11::register]]
SEXP dust_cpu_seirhdagevax_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
...
[[cpp11::register]]
SEXP dust_cpu_seirhdagevax_filter(SEXP ptr, SEXP time_end,
...
public:
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    }
    {
       ...
       int j = 1;
       internal.n_SE[i - 1 + shared->dim_n_SE_1 * (j - 1)] = internal.n_SE[shared->dim_n_SE_1 * 0 + shared->seed_age - 1] + dust::math::min(S[shared->dim_S_1 * 0 + shared->seed_age - 1] - internal.n_SE[shared->dim_n_SE_1 * 0 + shared->seed_age - 1], seed);
    }
...
SEXP dust_cpu_seirhdagevax_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<seirhdagevax>(r_pars, pars_multi, r_time, r_n_particles,
...
SEXP dust_cpu_seirhdagevax_simulate(SEXP ptr, cpp11::sexp r_time_end) {
