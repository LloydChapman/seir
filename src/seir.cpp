...
[[cpp11::register]]
SEXP dust_cpu_seir_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
...
[[cpp11::register]]
SEXP dust_cpu_seir_filter(SEXP ptr, SEXP time_end,
...
public:
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    real_type p_SE = 1 - dust::math::exp(- shared->beta * I / (real_type) N * shared->dt);
...
SEXP dust_cpu_seir_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<seir>(r_pars, pars_multi, r_time, r_n_particles,
...
SEXP dust_cpu_seir_simulate(SEXP ptr, cpp11::sexp r_time_end) {
